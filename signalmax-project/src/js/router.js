...
// Versi Perbaikan: 3.2 - Add Admin Notification Route
// Perubahan:
// - Menambahkan rute untuk halaman 'notifications-admin'.
...
export async function loadScreen(screenName, params = {}) {
    ...
    if (!route) {
        console.error(`Route "${screenName}" tidak ditemukan. Pastikan nama rute di 'seeAllLink' sesuai dengan yang ada di router.js (contoh: 'signals', 'community').`);
        return;
    }

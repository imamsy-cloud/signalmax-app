...
// Deskripsi: Logika untuk Halaman Manajemen Edukasi.
...
async function handleSaveCourse() {
    ...
    try {
        ...
        if (imageFile) {
            ...
            const storageRef = api.ref(api.storage, `courses/${Date.now()}_${processedImage.name}`);

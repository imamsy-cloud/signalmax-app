...
export {
    auth, db, storage, messaging, // <-- PERUBAHAN #1: 'messaging' ditambahkan
    onAuthStateChanged, GoogleAuthProvider, signInWithPopup,
    createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut,
    updatePassword, EmailAuthProvider, reauthenticateWithCredential,
    deleteUser, sendPasswordResetEmail,
    // Menambahkan getToken dan updateDoc untuk bisa diakses file lain
    getToken,
    updateDoc,
    collection, getDoc, getDocs, doc, serverTimestamp, setDoc,

...
// Versi Perbaikan: 6.0 (Final Notification Logic)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initGlobalListeners();
    // Panggilan initAuthListener sekarang menangani semua logika, termasuk notifikasi
    initAuthListener(); 
});

// --- PERUBAHAN #3: Fungsi notifikasi usang dihapus dari sini ---
// Kode `requestNotificationPermission` dan `listenForForegroundMessages`
// sudah dipindahkan dan diperbaiki di dalam auth.js

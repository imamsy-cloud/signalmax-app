...
// Versi Perbaikan: 3.0 (Final Notification Logic Fix)
...
import {
    ...
    // Impor baru yang diperlukan untuk notifikasi
...
// FUNGSI BARU: Meminta izin dan menyimpan token
...
export function initAuthListener() {
    onAuthStateChanged(auth, async (user) => {
        ...
        if (user) {
            ...
            // --- PERUBAHAN 2: Panggil fungsi notifikasi DI SINI ---
            setTimeout(requestAndSaveToken, 5000); // Tunggu 5 detik setelah login

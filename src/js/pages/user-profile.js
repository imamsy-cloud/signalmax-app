...
// Versi Perbaikan: 2.3 (Penambahan Tampilan Badge)
// Perubahan:
// - [FIX] Menambahkan logika untuk merender badge Premium dan Expert di dalam fungsi renderProfileHeader.
...
function renderProfileHeader(userData) {
    ...
    // --- PENAMBAHAN LOGIKA BADGE DIMULAI DI SINI ---
...
// [FIXED] Fungsi ini sekarang akan menampilkan data penulis dengan benar
function createPostElementForProfile(id, data) {
    ...
    card.innerHTML = `
        <div class="flex items-start space-x-3">
            <img alt="Avatar" class="w-10 h-10 rounded-full object-cover" src="${data.authorAvatar || 'https://placehold.co/40x40'}"/>
            <div class="flex-1">
                <div>
